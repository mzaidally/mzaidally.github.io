...
THREE.FirstPersonControls = function ( object, domElement ) {
	...
	this.onKeyDown = function ( event ) {
		...
		infoText.innerHTML = "testghnbvghjnvfghjkvguknvgyuiknbvgyuikvgyuikbgyu "
		infoText.style.position = 'absolute';
		infoText.style.width = 20;
		infoText.style.height = 20;
		infoText.style.color = "white";			
		infoText.style.top = 60 + 'px';
		infoText.style.right = 100 + 'px';
	...
	this.update = function( delta ) {
		...
		infoText = document.createElement('div')
			...
			infoText.innerHTML = "Press 'Q' to pause/resume "
			infoText.style.position = 'absolute';
			infoText.style.width = 20;
			infoText.style.height = 20;
			infoText.style.color = "white";
